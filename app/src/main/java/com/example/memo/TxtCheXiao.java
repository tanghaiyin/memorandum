...
public class TxtCheXiao {
     ...
     */
        ...
        /**
         * Create a new TxtCheXiao and attach it to the specified TextView.
         *
         * @param textView
         *            The text view for which the undo/redo is implemented.
         */
        public TxtCheXiao(TextView textView) {
            mTextView = textView;
        ...
        public void undo() {
            ...
            mIsUndoOrRedo = true;
            if (edit.mmBefore.length()>0){
                    text.replace(start, end, edit.mmBefore);
            }
            mIsUndoOrRedo = false;
            Log.e("撤销",edit.mmBefore.length()+"");
